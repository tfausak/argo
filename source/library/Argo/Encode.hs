...
encodePointer =
    ...
    in snd . runEncoder c . Pointer.encode

runEncoder :: Encoder.Config -> Encoder.Encoder a -> (a, Builder.Builder)
runEncoder c = Identity.runIdentity . Trans.runWriterT . flip Trans.runReaderT c
